...
export default function BiggestGame() {
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-2xl">
      ...
      <h1 className="text-3xl font-bold mb-2 flex items-center gap-3">
        <span className="text-4xl">📈</span> Kattasini top
      </h1>
      <p className="text-white/60 mb-6">To'g'ri javobni toping — eng katta yoki to'g'ri qiymat</p>
      ...
      {finished ? (
        ...
        <div className="relative">
          ...
          <div className="relative card p-6 border-amber-500/30">
