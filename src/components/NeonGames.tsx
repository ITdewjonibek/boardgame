...
const games = [
  ...
  { title: "ARQON TORTISH", desc: "Jamoaviy arqon tortish o'yinida g'alaba qozoning", usage: "600+", emoji: "🪢", color: "orange", path: "/games/tug-of-war" },
  { title: "SO'Z QIDIRUV", desc: "Aralash harflar maydonidan so'zlarni topish o'yini", usage: "650+", emoji: "🔤", color: "green", path: "/games/word-search" },
  ...
  { title: "CHEMPION O'QUVCHI", desc: "O'quvchilar turnir ko'rinishida kubok uchun bellashishadi", usage: "250+", emoji: "🏆", color: "yellow", path: "/games/champion" },
  { title: "DAVLATNI TOP", desc: "Bayroq orqali davlat nomini to'g'ri toping", usage: "250+", emoji: "🌍", color: "magenta", path: "/games/country" },
